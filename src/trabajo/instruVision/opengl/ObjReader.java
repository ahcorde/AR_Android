package trabajo.instruVision.opengl;
...
public class ObjReader
  {
    ...
    public static ObjReader.Model ReadObj(final String ObjFileName){
        ObjReader.Model Result = null;
        try{
            Result = ObjReader.ReadObj(/*FileName =*/ ObjFileName,
          		/*LoadMaterials =*/new ObjReader.MaterialLoader(){
          	  
          	  	public ObjReader.MaterialSet Load(
          	  						ObjReader.MaterialSet Materials,
          	  						String MatFileName){
          	  		
                        return ObjReader.ReadMaterials(/*FileName =*/new java.io.File(
      ...
      /* no support for texture files, functions or any of that stuff */
            ...
            this.AmbientColor =
                AmbientColor != null ?
                    new GeomBuilder.Color(
                        ...
                        AmbientColor.g,
                        AmbientColor.b,
                        Alpha) :new GeomBuilder.Color(1.0f, 1.0f, 1.0f, Alpha);
                        
            this.DiffuseColor =DiffuseColor != null ? new GeomBuilder.Color(
                        DiffuseColor.r,
                        DiffuseColor.g,
                        DiffuseColor.b,
                        Alpha) :new GeomBuilder.Color(1.0f, 1.0f, 1.0f, Alpha);
                        
            this.SpecularColor =SpecularColor != null ?  new GeomBuilder.Color
                      (SpecularColor.r,
                        SpecularColor.g,
                        SpecularColor.b,
                        Alpha ):new GeomBuilder.Color(1.0f, 1.0f, 1.0f, Alpha);
        ...
        public void Apply(GL10 gl){
          ...
          /* Illum NYI */
            ...
            gl.glMaterialfv ( GL10.GL_FRONT_AND_BACK,GLES11.GL_AMBIENT,
                    new float[]{ AmbientColor.r,
                            AmbientColor.g,
                            AmbientColor.b,
                            AmbientColor.a, }, 0);
            ...
            gl.glMaterialfv (GL10.GL_FRONT_AND_BACK, GL10.GL_SPECULAR, new float[]{
                            SpecularColor.r,
                            SpecularColor.g,
                            SpecularColor.b,
                            SpecularColor.a,}, 0 );
            gl.glMaterialf(GL10.GL_FRONT_AND_BACK,GL10.GL_SHININESS,SpecularExponent);
          } /*Apply*/
    ...
    public static class MaterialSet{
      /* a mapping from material names to material definitions */
        ...
        public void Add( Material TheMaterial){
    ...
    private static class ObjTokenizer{
        ...
        public void Fail(String Msg){
            throw new DataFormatException(String.format( "ObjReader error at line %d, col %d: %s",
            		LineNr, ColNr,Msg ) );
          
        } /*Fail*/

        public ObjTokenizer(java.io.InputStream Input){
            this.Input = Input;
            EOL = false;
            EOF = false;
            LastWasCR = false;
        ...
        public String NextSym( boolean Required){
          /* fetches next symbol from current line, or null if none. */
            ...
            final String Result =
                CurSym.length() != 0 ?CurSym.toString():null;
        ...
        public String GetRestOfLine(){
          /* returns rest of current line (excluding leading whitespace, but
            ...
            final String Result =CurSym.length() != 0 ? CurSym.toString(): null;
            if (Result == null) {
                Fail("missing required symbol");
        ...
        public GeomBuilder.Vec3f GetVec (int MinD, int MaxD ) {
        ...
        private static class Component
          {
            ...
            private Component( Material ObjMaterial, GeomBuilder.Obj ObjGeometry)
              {
        ...
        public void Draw(GL10 gl) {
            ...
            for (Component ThisComponent : Components){
                ...
                ThisComponent.ObjGeometry.Draw(gl, 
                		ThisComponent.ObjMaterial.DiffuseColor.r, 
                		ThisComponent.ObjMaterial.DiffuseColor.g, 
                		ThisComponent.ObjMaterial.DiffuseColor.b, 
                		ThisComponent.ObjMaterial.DiffuseColor.a);
            } /*for*/
        } /*Draw*/
        ...
        for (;;)
          {
            ...
            if (Op == null && Parse.EOF || Op == "newmtl")
            ...
            else if (Op != null)
              {
                if (MaterialName == null)
                  {
                    Parse.Fail("material definition doesn' t begin with ");
                  } /*if*/
                if (Op == "Ka")
                  {
    ...
    public static Model ReadObj( String FileName, MaterialLoader LoadMaterials )
    throws DataFormatException
      {
        Model Result = null;
